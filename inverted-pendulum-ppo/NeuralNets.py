...
# Adding recurrence to Actor
class ActorNNRecurrence(nn.Module):
    def __init__(self, input_size, output_size, hidden_size, n_layers):
        super(ActorNNRecurrence, self).__init__()
    ...
    def forward(self, state):
        ...
        for i in range(self.n_layers):
            network = self.tanh(self.hidden_layer(network))
        network = self.lstm_layer(network)
        mean = self.output_layer(network)
...
# Adding Recurrence to Critic
class CriticNNRecurrence(nn.Module):
    def __init__(self, input_size, output_size, hidden_size, n_layers):
        super(CriticNNRecurrence, self).__init__()
